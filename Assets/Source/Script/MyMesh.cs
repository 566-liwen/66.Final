...
public partial class MyMesh : MonoBehaviour {
    public float kInitSize_x = 10f;
    public float kInitSize_y = 10f;
    public float kInitSize_z = 10f;
    ...
    protected void Start()
    {
        ...
        transform.localScale = new Vector3(kInitSize_x, kInitSize_y, kInitSize_z);
