...
public class RenderPipelineInstance : RenderPipeline
{
    ...
    private int[] _GBufferNameIDs = {
            ...
            ShaderConstants.GBuffer4,
            ShaderConstants.GBuffer5,
            ShaderConstants.GBuffer6,
            ShaderConstants.GBuffer7
        };
    private RenderTextureFormat[] _GBufferFormats = {
            RenderTextureFormat.ARGBFloat, //ARGB32
    ...
    protected void OnPostCameraCulling(ScriptableRenderContext context, Camera camera, ref CullingResults cullingResults)
    {
        ...
        Vector3 lightPosition = lightTrans.position;
        Shader.SetGlobalColor("_CameraPosition", new Color(cameraPostion.x, cameraPostion.y, cameraPostion.z, 1));
        Shader.SetGlobalColor("_LightPosition", new Color(lightPosition.x, lightPosition.y, lightPosition.z, 1)); // need to move
...
/*        RenderTextureDescriptor depthDesc = new RenderTextureDescriptor(camera.pixelWidth, camera.pixelHeight, RenderTextureFormat.Depth, 32, 1);
    ...
    private void AcquireGBuffersIfNot(ScriptableRenderContext context, Camera camera)
    {
        ...
        {
            _commandbuffer.Clear();
            _GBufferRTIs = new RenderTargetIdentifier[8];
            for (var i = 0; i < 8; i++)
            {
    ...
    {
        public static readonly int GBuffer0 = Shader.PropertyToID("_Buffer0");
        public static readonly int GBuffer1 = Shader.PropertyToID("_Buffer1");
        public static readonly int GBuffer2 = Shader.PropertyToID("_Buffer2");
        public static readonly int GBuffer3 = Shader.PropertyToID("_Buffer3");
        public static readonly int GBuffer4 = Shader.PropertyToID("_Buffer4");
        public static readonly int GBuffer5 = Shader.PropertyToID("_Buffer5");
        public static readonly int GBuffer6 = Shader.PropertyToID("_Buffer6");
        public static readonly int GBuffer7 = Shader.PropertyToID("_Buffer7");
